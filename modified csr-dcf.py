  ...
  for video_name in video_tracks:
      ...
      for track_index,track in enumerate(video__tracks):
          ...
          for anno_index,single_anno in enumerate(video_anno):
              ...
              if mean_dis>50 or anno_index in finally_selected_anno:
                  continue
              else:
...
def main():
    ...
    result=evaluate(tracks,anno)
    return(tracks,tracks_details,result,anno)
